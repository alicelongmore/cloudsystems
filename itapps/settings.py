...
'default': {
    ...
    'PASSWORD': os.environ['AZURE_DB_PASSWORD'], # Replace with the actual path to my.cnf
    }
}
...
LOGIN_REDIRECT_URL = 'modreg:home'
LOGIN_URL = 'login' 
...
EMAIL_HOST_USER = 'alicelongmore2@gmail.com'
EMAIL_HOST_PASSWORD = 'ofij lstq acpm zgle'
